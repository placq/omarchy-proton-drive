...
The authenticated integration identifies itself with `x-pm-appversion: external-drive-omarchy_drive@0.3.0-alpha.2`; the constant is exported by `ProtonSdkProvider`. It never impersonates a first-party client.
